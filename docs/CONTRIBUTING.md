...
- [hack](https://github.com/victor-gp/cmd-help-sublime-syntax/wiki/Development) on the code and [make a Pull Request](https://github.com/victor-gp/cmd-help-sublime-syntax/pulls)
